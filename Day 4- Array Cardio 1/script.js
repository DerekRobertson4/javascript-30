...
console.log('List of inventors born in the 1500\'s:');
  const fifteen = inventors.filter(age => age.year >= 1500 && age.year < 1600);
console.table(fifteen);
  
// Array.prototype.map()
  // 2. Give us an array of the inventors first and last names
console.log('Array of inventors first and last names:');
...
// Array.prototype.reduce()
  ...
  console.log('Total years of inventors lives combined:');
...
console.log('List of strings sorted by last name:');
...
console.log('A sum of all intances in an array:');
